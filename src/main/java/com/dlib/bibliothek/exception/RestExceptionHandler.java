...
public class RestExceptionHandler {
	...
	@ResponseStatus(HttpStatus.BAD_REQUEST)
	public ApiResponse malformedJwtException(final MalformedJwtException ex) {
		return ApiResponse.builder().error(true).errorCode(HttpStatus.BAD_REQUEST.value()).message(ex.getMessage())
				.build();
	}
	...
	@ResponseStatus(HttpStatus.UNAUTHORIZED)
	public ApiResponse expiredJwtExceptionHandler(final ExpiredJwtException ex) {
		return ApiResponse.builder().error(true).errorCode(HttpStatus.UNAUTHORIZED.value()).message(ex.getMessage())
				.build();
	}
	...
	@ResponseStatus(HttpStatus.UNAUTHORIZED)
	public ApiResponse expiredJwtExceptionHandler(final AuthenticationException ex) {
		return ApiResponse.builder().error(true).errorCode(HttpStatus.UNAUTHORIZED.value()).message(ex.getMessage())
				.build();
	}
