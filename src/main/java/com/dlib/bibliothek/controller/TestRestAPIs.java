...
public class TestRestAPIs {
	...
	@GetMapping("/testApiBook")
	public List<BookReturnResponse> testApiBook(@RequestParam int id) {
		return bookRepository.findAllReturnAlert(10);
	}

	private final static String AUTHORITY = "https://login.microsoftonline.com/common/";
	private final static String CLIENT_ID = "829d8324-2ae3-40ba-a9ce-45b2473e57ef";

	@GetMapping("/testPush")
	public void testApiWatch() {
		try (BufferedReader br = new BufferedReader(new InputStreamReader(System.in))) {
			String username = "anson.f@toshokan.onmicrosoft.com";
			String password = "xq0m8NGSQDTibX7uSvRgbK9b1Vd0a1q5";
		...
		} catch (IOException | InterruptedException | ExecutionException | ServiceUnavailableException e) {
	...
	@GetMapping("/testBlaBla")
	public List<User> testPushNot() throws InterruptedException, ExecutionException {
